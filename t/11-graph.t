...
sub getGraphJoinSQL {
  ...
  my $expectedGraphJoinSQLSnowflakeStores = $expectedGraphJoinSQLStarStores;
  $expectedGraphJoinSQLSnowflakeStores .= qq{
     MERGE INTO MART_TABLE_JOIN A USING
      (
      WITH C AS
        ( SELECT COUNT (*) AS rec_count
      ...
      FROM  (
        SELECT
          ...
          1 as FIELD_JOIN_ORD,
          'JJJ' as TYPE,
          'AUTO-GENERATED BY JoinHero Version: $JoinHero::VERSION using S_LPS_FK in REVERSED mode' as NOTES,
          'Y' as CORE_FLG
        FROM DUAL
      ) mtj
        CROSS JOIN c
