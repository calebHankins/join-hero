...
sub sqlGenerationS_SL_FKBasic {
  ...
  my $getJoinSQL_S_SL_FKExpectedSQL = qq{
      ...
      FROM  (
        SELECT
          ...
          1 as FIELD_JOIN_ORD,
          'SAMPLE' as TYPE,
          'AUTO-GENERATED BY JoinHero Version: $JoinHero::VERSION using S_SL_FK I <3 unit tests' as NOTES,
          'Y' as CORE_FLG
        FROM DUAL
      ) mtj
        CROSS JOIN c
  ...
  my $fkKey                = 'S_SL_FK-_-JJJ.STORES-_-JJJ.STORE_LOCATIONS';
  my $additionalNoteSuffix = ' I <3 unit tests';
  my $getJoinSQLParams
    = {pkComponents => $pk_01, fkComponents => $fk_01, additionalNoteSuffix => $additionalNoteSuffix};
